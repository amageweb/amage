      ...
      <div style={{
        ...
        <div style={{ 
          ...
          >
            ...
            <div style={{
              ...
              >
                <svg width={isMobile ? "32" : "38"} height={isMobile ? "32" : "38"} viewBox="0 0 24 24" fill="currentColor">
        ...
        <div style={{
          ...
          <p style={{
            ...
            © 2025 Amage Tecnologia e Desenvolvimento. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
